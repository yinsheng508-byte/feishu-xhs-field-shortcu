 ...
 * - character ranges (using [...])
 */
export declare function parseGlob(pattern: string | IRelativePattern, options?: IGlobOptions): ParsedPattern;
export declare function parseGlob(expression: IExpression, options?: IGlobOptions): ParsedExpression;
