...
export declare type ConstructorOf<T = any> = new (...args: any[]) => T;
export declare type TokenResult<T extends Token> = T extends ConstructorOf<infer R> ? R : any;
export declare type Token = string | symbol | Function;
export declare type Tag = string | number;
export declare type Domain = string | symbol;
export declare const INJECTOR_TOKEN: Token;
/**
...
export declare type TypeProvider = ConstructorOf<any>;
...
export declare type Provider = ClassProvider | TypeProvider | ValueProvider | AliasProvider | FactoryProvider<any>;
...
export declare type InstanceCreator = ValueCreator | ClassCreator | FactoryCreator | AliasCreator;
...
export declare type MethodName = string | number | symbol;
...
export declare type IBeforeAspectHookFunction<ThisType = any, Args extends any[] = any[], Result = any> = (joinPoint: IBeforeJoinPoint<ThisType, Args, Result>) => void | Promise<void>;
export declare type IAfterAspectHookFunction<ThisType = any, Args extends any[] = any[], Result = any> = (joinPoint: IAfterJoinPoint<ThisType, Args, Result>) => void | Promise<void>;
export declare type IAroundAspectHookFunction<ThisType = any, Args extends any[] = any[], Result = any> = (joinPoint: IAroundJoinPoint<ThisType, Args, Result>) => void | Promise<void>;
export declare type IAfterReturningAspectHookFunction<ThisType = any, Args extends any[] = any[], Result = any> = (joinPoint: IAfterReturningJoinPoint<ThisType, Args, Result>) => void | Promise<void>;
export declare type IAfterThrowingAspectHookFunction<ThisType = any, Args extends any[] = any[], Result = any> = (joinPoint: IAfterThrowingJoinPoint<ThisType, Args, Result>) => void | Promise<void>;
export declare type IAspectHookTypeFunction<ThisType, Args extends any[], Result> = IBeforeAspectHookFunction<ThisType, Args, Result> | IAfterAspectHookFunction<ThisType, Args, Result> | IAroundAspectHookFunction<ThisType, Args, Result> | IAfterReturningAspectHookFunction<ThisType, Args, Result> | IAfterThrowingAspectHookFunction<ThisType, Args, Result>;
export declare type IInstanceHooks = Map<MethodName, IValidAspectHook[]>;
export declare type IHookMap = Map<Token, IInstanceHooks>;
/**
...
export declare type IValidAspectHook<ThisType = any, Args extends any[] = any[], Result = any> = IBeforeAspectHook<ThisType, Args, Result> | IAfterAspectHook<ThisType, Args, Result> | IAroundAspectHook<ThisType, Args, Result> | IAfterReturningAspectHook<ThisType, Args, Result> | IAfterThrowingAspectHook<ThisType, Args, Result>;
export interface IBeforeAspectHook<ThisType = any, Args extends any[] = any[], Result = any> extends IAspectHook<ThisType, Args, Result> {
    type: HookType.Before;
    hook: IBeforeAspectHookFunction<ThisType, Args, Result>;
}
export interface IAfterAspectHook<ThisType = any, Args extends any[] = any[], Result = any> extends IAspectHook<ThisType, Args, Result> {
    type: HookType.After;
    hook: IAfterAspectHookFunction<ThisType, Args, Result>;
}
export interface IAfterReturningAspectHook<ThisType = any, Args extends any[] = any[], Result = any> extends IAspectHook<ThisType, Args, Result> {
    type: HookType.AfterReturning;
    hook: IAfterReturningAspectHookFunction<ThisType, Args, Result>;
}
export interface IAroundAspectHook<ThisType = any, Args extends any[] = any[], Result = any> extends IAspectHook<ThisType, Args, Result> {
    type: HookType.Around;
    hook: IAroundAspectHookFunction<ThisType, Args, Result>;
}
export interface IAfterThrowingAspectHook<ThisType = any, Args extends any[] = any[], Result = any> extends IAspectHook<ThisType, Args, Result> {
