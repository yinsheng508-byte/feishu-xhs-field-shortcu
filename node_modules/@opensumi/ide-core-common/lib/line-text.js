...
exports.BasicTextLines = void 0;
class BasicTextLines {
    constructor(_lines, _eol) {
        this._lines = _lines;
        this._eol = _eol;
    }
    getContent() {
    ...
    _acceptDeleteRange(range) {
        if (range.startLineNumber === range.endLineNumber) {
            ...
            this._setLineText(range.startLineNumber - 1, this._getLineContent(range.startLineNumber - 1).substring(0, range.startColumn - 1) +
    ...
    _acceptInsertText(position, insertText) {
        ...
        if (insertLines.length === 1) {
            ...
            this._setLineText(position.lineNumber - 1, this._getLineContent(position.lineNumber - 1).substring(0, position.column - 1) +
                insertLines[0] +
        ...
        this._setLineText(position.lineNumber - 1, this._getLineContent(position.lineNumber - 1).substring(0, position.column - 1) + insertLines[0]);
...
exports.BasicTextLines = BasicTextLines;
