...
export declare function WASMInterface(binary: any, hashLength: number): Promise<{
    ...
    init: (bits?: number | null) => void;
    update: (data: IDataType) => void;
    digest: (outputType: 'hex' | 'binary', padding?: number | null) => Uint8Array | string;
    save: () => Uint8Array;
    load: (state: Uint8Array) => void;
    calculate: (data: IDataType, initParam?: null, digestParam?: null) => string;
    hashLength: number;
}>;
export type IWASMInterface = ThenArg<ReturnType<typeof WASMInterface>>;
export {};
//# sourceMappingURL=WASMInterface.d.ts.map