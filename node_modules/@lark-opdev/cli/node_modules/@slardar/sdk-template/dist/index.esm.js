...
export { BUFFER_TIME, ContextPlugin, EVENTS, IntegrationPlugin, LOGGER_NAME, LoggerPlugin, SubjectPlugin, applyBufferTimer, applyRecord, arrayIncludes, arrayRemove, camelToKebab, cloneArray, createBaseConfigManager, createBatchSender, createClient, createContextAgent, createLogger, createMergeConfigManager, createSafeObserver, directBuilder, error, filterObjectValueBy, getRegexp, hasKey, hookMethodDangerously, hookObjectProperty, id, initPrivateSubject, initSubjectInGlobal, isArray, isBoolean, isEqual, isEqualArray, isEqualPlainObject, isError, isErrorEvent, isEvent, isFunction, isHitByRandom, isHitBySampleRate, isInstanceOf, isNumber, isObject, isPlainObject, isPromiseRejectionEvent, isString, joinQueryWithMap, joinRegExp, log, mergeDeepConcatArray, mergeDeepCopyArray, nextLink, noop, noopBuilder, noopSender, objectForIn, omit, pick, runProcessors, safeCall, safeCallOrGet, safeJoin, safeSet, safeStringify, safeVisit, stringifyBatch, toObservable, uuid, warn, withCommandArray };
